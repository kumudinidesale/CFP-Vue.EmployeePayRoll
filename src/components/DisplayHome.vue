          ...
          <tr>
            ...
            <th>Actions</th>
             ...
             <tr v-for="employee in employees" :key="employee.id">
                        ...
                        <td> {{employee.note}}</td>
                         <td>
                      <img @click="remove(employee.id)" src="../assets/images delete.png" alt="delete" width="30" height="30"/>
                      <img @click="update(employee.id)" src="../assets/images 1.png" alt="edit" width="30" height="30" />
                    </td>
                    </tr>
          </tbody>
          </table>
